...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Mensaje de inicio</label>
	             <textarea name="intro" id="" cols="30" rows="2" class="form-control"><?php echo  $_settings->info('intro') ?></textarea>
			</div>
			<div class="form-group">
				<label for="" class="control-label">Mensaje de error</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Avatar del Bot </label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Avatar de usuario</label>
				<div class="custom-file">
