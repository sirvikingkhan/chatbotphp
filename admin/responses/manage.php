...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($_GET['id']) ? "Update ": "Create New " ?>Respuesta a la pregunta</h3>
	</div>
	<div class="card-body">
		<form action="" id="response-form">
			...
			<div class="form-group">
                ...
                <small><i>(Haga clic en "<b> + </b>" para agregar la pregunta.)</i></small>
			</div>
			<?php else: ?>
				<div class="form-group">
					<label for="question_field" class="control-label">Pregunta</label>
			...
			<div class="form-group">
				<label for="response_message" class="control-label">Mensaje de respuesta</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="response-form">Guardar</button>
		<a class="btn btn-flat btn-default" href="?page=responses">Cancelar</a>
	</div>
</div>
<script>
	$(document).ready(function(){
